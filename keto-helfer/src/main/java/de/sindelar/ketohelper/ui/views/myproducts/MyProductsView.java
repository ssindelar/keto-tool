package de.sindelar.ketohelper.ui.views.myproducts;
...
@Route(value = "myproducts", layout = MainView.class)
@PageTitle("Meine Produkte")
@CssImport("./views/myproducts-view.css")
public class MyProductsView extends Div implements AfterNavigationObserver {

	private static final long serialVersionUID = 9098906824107709480L;
	Grid<Person> grid = new Grid<>();

	public MyProductsView() {
		addClassName("myProducts-view");
		setSizeFull();
		grid.setHeight("100%");
